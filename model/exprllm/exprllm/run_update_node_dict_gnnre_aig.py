...
from run_update_node_dict import expr2text_attr
from run_update_node_dict import get_physical_attr
from run_update_node_dict import get_node_type
from run_update_node_dict import update_one_node
...
def expr2vec_one_design(design_name, l2v):
    ...
    save_dir_ori = f"/home/usr/NetTAG/preprocess/net2graph_{cmd}/saved_node_dict_tag"
...
def main():
    ...
    with open ("../../../data_collect/data_js_gnnre/design_list.json", 'r') as f:
